...
@section('mainarea')
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{ route('admin.noticeboards.index') }}">Note de service</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="">Edit Communiqué</a>
					</li>
				</ul>
                ...
                {{--END ERROR MESSAGE BOX--}}
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Edit Communiqué
							</div>
							<div class="tools">
							</div>
						</div>
						...
						{!! Form::open(array( 'id' => 'edit_noticeboards_form','class'=>'form-horizontal form-bordered','method'=>'PUT')) !!}
                                    ...
                                    <div class="form-body">
                                        ...
                                        <label class="col-md-2 control-label">Titre: <span class="required">
                                        * </span>
                                            </label>
                                            <div class="col-md-6">
										...
										<div class="form-group">
                                        <label class="col-md-2 control-label">Lieu: <span class="required">
                                        * </span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="lieu" placeholder="Lieu" value="{{$notice->lieu}}">
                                            </div>
                                        </div>
										
										<div class="form-group">
										<label class="col-md-2 control-label">Activité: <span class="required">
                                        * </span>
                                            </label>
                                            <div class="col-md-6">
												<select class="form-control" name="activité">

												<option value="reportée" @if($notice->activité=='reportée') selected @endif>Reportée</option>
												<option value="maintenue" @if($notice->activité=='maintenue') selected @endif>Maintenue</option>
												</select>
											</div>
										</div>
                                         <div class="form-group">
