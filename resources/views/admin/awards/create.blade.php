...
@section('mainarea')
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{ route('admin.awards.index') }}">Récompenses</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="">Donner des Primes</a>
					</li>
				</ul>
                ...
                {{--END ERROR MESSAGE BOX--}}
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-trophy"></i>Donner des Primes
							</div>
							<div class="tools">
							</div>
						</div>
						...
						{!! Form::open(array('class'=>'form-horizontal form-bordered','method'=>'POST', 'id' => 'award_store_form')) !!}
                                    ...
                                    <div class="form-body">
                                        ...
                                        * </span>
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="awardName" placeholder="Intitulé" value="{{ \Illuminate\Support\Facades\Input::old('awardName') }}">
                                            </div>
                                        </div>
                                        ...
                                        <label class="col-md-2 control-label">Cadeau: <span class="required">
                                            * </span>
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="gift" placeholder="Cadeau" value="{{ \Illuminate\Support\Facades\Input::old('gift') }}" >
                                            </div>
                                        </div>
