...
@section('mainarea')
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="{{ route('admin.awards.index') }}">Primes</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href=""> Edit Récompenses</a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Edit Récompenses
							</div>
							<div class="tools">
							</div>
						</div>
						...
						<!------------------------ BEGIN FORM---------------------->
                            ...
                            <label class="col-md-2 control-label">Intitulé: <span class="required">
                            * </span>
                                </label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="awardName" placeholder="Intitulé" value="{{ $award->awardName }}">
                                </div>
                            </div>

                            <div class="form-group">
                            <label class="col-md-2 control-label">Cadeau: <span class="required">
                                * </span>
                                </label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="gift" placeholder="Cadeau" value="{{ $award->gift }}" >
                                </div>
                            </div>
                           ...
                           <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Nom Employé:</label>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Mois:</label>
                                     ...
                                     <label class="col-md-2 control-label">Année:</label>
                                           ...
                                           <div class="col-md-3">
                                                    {!!  Form::selectYear('forYear', 2013, 2030,$award->forYear,['class'=>'form-control select2me'])  !!}
                                     </div>
                                                    </div>
