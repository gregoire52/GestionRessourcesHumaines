...
class Employee extends \Eloquent implements Authenticatable
{
    ...
    protected $fillable = ['employeeID','designation','fullName','fatherName','fonction','gender','campus','site','situation','statut','email','password','date_of_birth','mobileNumber','localAddress','profileImage','joiningDate','permanentAddress'];
